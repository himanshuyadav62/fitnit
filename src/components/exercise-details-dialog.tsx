...
export function ExerciseDetailsDialog({ id, slug, name, userNotes, videoUrl }: { id: string; slug: string; name: string; userNotes: string | null; videoUrl: string | null }) {
  ...
  return <Dialog open={open} onOpenChange={setOpen}>
    <DialogTrigger asChild><Button type="button" variant="ghost" size="icon-sm" aria-label={`Edit notes for ${name}`}><FilePenLine /></Button></DialogTrigger>

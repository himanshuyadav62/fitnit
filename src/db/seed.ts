...
import { createExerciseGuide, exerciseGuides } from "./exercise-guides";
...
const exerciseSeed: ExerciseSeed[] = rawExercises.map(([slug, name, movementPattern, primaryMuscles, equipment, instructions, cues]) => ({
  ...
  instructions,
  cues,
  guide: exerciseGuides[slug] ?? createExerciseGuide({ name, movementPattern, primaryMuscles, equipment, instructions, cues }),
...
const templates: TemplateSeed[] = [
  ...
  {
    slug: "upper-lower-ppl-reference-5-day", title: "Upper / Lower + PPL Reference — 5 Days", daysPerWeek: 5, durationWeeks: 8,
    description: "A memorable five-day muscle-building week: Monday Upper, Tuesday Lower, Wednesday recovery, then Push, Pull and Legs before a full Sunday rest.",
    goal: "build_muscle", experience: "intermediate", nutritionNotes: "Weekly rhythm: Mon Upper, Tue Lower, Wed active recovery, Thu Push, Fri Pull, Sat Legs, Sun full rest. On Wednesday use 20–30 minutes of easy walking plus about 10 minutes of light mobility—no hard lifting. Warm up 5–10 minutes and use 2–4 ramp-up sets before the first compound. Keep most work at 1–3 RIR, use full controlled range of motion, and progress within the rep range before adding 2.5–5% load. If fatigue accumulates across several workouts, halve the normal sets and stay around 3–4 RIR for one deload week.",
    workouts: [
      { title: "Monday — Upper A", focus: "Upper-body strength and hypertrophy", exercises: [["barbell-bench-press",3,4,6,180,2], ["lat-pulldown",3,6,8,180,2,"Pull-ups are an equivalent option."], ["incline-dumbbell-press",2,8,12,120,2], ["chest-supported-dumbbell-row",3,8,12,120,2], ["dumbbell-lateral-raise",3,12,20,75,2,"A cable lateral raise is an equivalent option."], ["incline-dumbbell-curl",2,10,15,75,2,"Any controlled biceps curl is suitable."], ["cable-triceps-pressdown",2,10,15,75,2,"An overhead triceps extension is an equivalent option."]] },
      { title: "Tuesday — Lower A", focus: "Squat strength and posterior-chain hypertrophy", exercises: [["barbell-back-squat",3,5,8,180,2], ["dumbbell-romanian-deadlift",3,6,10,150,2], ["leg-press",2,10,15,120,2], ["seated-leg-curl",3,10,15,90,2,"A lying leg curl is an equivalent option."], ["standing-calf-raise",3,10,15,75,2], ["cable-crunch",3,10,15,60,2,"A hanging knee or leg raise is an equivalent option."]] },
      { title: "Thursday — Push", focus: "Chest, shoulders and triceps hypertrophy", exercises: [["incline-dumbbell-press",3,6,10,150,2,"A low-incline barbell press is an equivalent option."], ["dumbbell-bench-press",3,8,12,120,2,"Use a flat chest-press machine if preferred."], ["seated-dumbbell-overhead-press",2,8,12,120,2], ["dumbbell-lateral-raise",3,12,20,75,1,"A cable lateral raise is an equivalent option."], ["cable-chest-fly",2,12,15,75,1,"A pec deck is an equivalent option."], ["cable-triceps-pressdown",3,10,15,75,1]] },
      { title: "Friday — Pull", focus: "Lats, upper back, rear delts and biceps", exercises: [["lat-pulldown",3,6,10,150,2,"Pull-ups are an equivalent option."], ["barbell-row",3,6,10,150,2,"A T-bar row is an equivalent option."], ["seated-cable-row",2,8,12,120,2], ["face-pull",3,12,20,75,1,"Use a reverse pec deck or rear-delt fly if preferred."], ["incline-dumbbell-curl",3,8,12,75,2], ["incline-dumbbell-curl",2,10,15,75,1,"Use a neutral grip to perform these as hammer curls."]] },
      { title: "Saturday — Legs B", focus: "Quad, hamstring and single-leg hypertrophy", exercises: [["barbell-back-squat",3,6,10,180,2,"A hack squat or front squat is an equivalent option."], ["dumbbell-romanian-deadlift",2,8,10,150,2], ["rear-foot-elevated-split-squat",2,8,12,120,2,"Prescription is per leg."], ["leg-extension",2,12,15,75,1], ["seated-leg-curl",3,10,15,75,1], ["standing-calf-raise",3,10,15,75,2,"A seated calf raise is an equivalent option."], ["cable-crunch",3,10,15,60,2]] },
    ],
  },
  {
    slug: "upper-lower-ppl-progression-5-day", title: "Upper / Lower + PPL Progression — 5 Days", daysPerWeek: 5, durationWeeks: 12,
    description: "A fixed 8–12 week progression block with explicit RIR, longer compound rests and repeatable weekly recovery days.",
    goal: "build_muscle", experience: "intermediate", nutritionNotes: "Keep this plan unchanged for 8–12 weeks. Weekly rhythm: Mon Upper, Tue Lower, Wed active recovery, Thu Push, Fri Pull, Sat Legs, Sun full rest. Wednesday is 20–30 minutes of easy walking plus 10 minutes of light mobility. Log load and reps every session. Use double progression: reach the top of the range on every set at the prescribed RIR, then add roughly 2.5–5% load. Do 2–4 ramp-up sets before the first heavy compound. Do not routinely take squats, RDLs or presses to failure. Deload with about half the sets, lighter loads and 3–4 RIR when performance, motivation or recovery declines for several sessions.",
    workouts: [
      { title: "Monday — Upper A", focus: "Strength plus hypertrophy", exercises: [["barbell-bench-press",3,4,6,240,3], ["lat-pulldown",3,6,8,180,2,"Pull-ups are an equivalent option."], ["incline-dumbbell-press",2,8,12,120,2], ["chest-supported-dumbbell-row",3,8,12,120,2], ["dumbbell-lateral-raise",3,12,20,75,2,"A cable lateral raise is an equivalent option."], ["incline-dumbbell-curl",2,10,15,75,2], ["cable-triceps-pressdown",2,10,15,75,2,"An overhead triceps extension is an equivalent option."]] },
      { title: "Tuesday — Lower A", focus: "Strength plus hypertrophy", exercises: [["barbell-back-squat",3,5,8,240,3], ["dumbbell-romanian-deadlift",3,6,10,180,2], ["leg-press",2,10,15,120,2], ["seated-leg-curl",3,10,15,90,2,"A lying leg curl is an equivalent option."], ["standing-calf-raise",3,10,15,75,2], ["cable-crunch",3,10,15,60,2,"A hanging knee or leg raise is an equivalent option."]] },
      { title: "Thursday — Push B", focus: "Hypertrophy with controlled proximity to failure", exercises: [["incline-dumbbell-press",3,6,10,180,2,"A low-incline barbell press is an equivalent option."], ["dumbbell-bench-press",3,8,12,120,2,"Use a flat chest-press machine if preferred."], ["seated-dumbbell-overhead-press",2,8,12,120,2], ["dumbbell-lateral-raise",3,12,20,75,1,"A cable lateral raise is an equivalent option."], ["cable-chest-fly",2,12,15,75,1,"A pec deck is an equivalent option."], ["cable-triceps-pressdown",3,10,15,75,1]] },
      { title: "Friday — Pull B", focus: "Hypertrophy with balanced vertical and horizontal pulling", exercises: [["lat-pulldown",3,6,10,180,2,"Pull-ups are an equivalent option."], ["barbell-row",3,6,10,180,2,"A T-bar row is an equivalent option."], ["seated-cable-row",2,8,12,120,2], ["face-pull",3,12,20,75,1,"Use a reverse pec deck or rear-delt fly if preferred."], ["incline-dumbbell-curl",3,8,12,75,2], ["incline-dumbbell-curl",2,10,15,75,1,"Use a neutral grip to perform these as hammer curls."]] },
      { title: "Saturday — Legs B", focus: "Hypertrophy with quad, hinge and unilateral work", exercises: [["barbell-back-squat",3,6,10,180,2,"A hack squat or front squat is an equivalent option."], ["dumbbell-romanian-deadlift",2,8,10,180,2], ["rear-foot-elevated-split-squat",2,8,12,120,2,"Prescription is per leg."], ["leg-extension",2,12,15,75,1], ["seated-leg-curl",3,10,15,75,1], ["standing-calf-raise",3,10,15,75,2,"A seated calf raise is an equivalent option."], ["cable-crunch",3,10,15,60,2]] },
    ],
  },
  {
    slug: "personalized-push-pull-legs-6-day", title: "Personalized Push / Pull / Legs — 6 Days", daysPerWeek: 6, durationWeeks: 10, isFeatured: true,
    description: "A complete six-day hypertrophy split with two distinct push, pull and leg sessions, prescribed tempos, generous compound rest and practical equipment alternatives.",
    goal: "build_muscle", experience: "intermediate", nutritionNotes: "Run this plan for 8–12 weeks before making major changes. Tempo is written eccentric-pause-lift: 2-0-1 means lower for two seconds, do not pause, then lift in about one second; 2-1-2 adds a one-second pause and controlled two-second return. Keep most sets around 1–3 RIR, record every working set, and progress inside the rep range before adding load. Sunday is full rest. If six days begins to reduce performance or recovery, take an extra rest day or remove one isolation set from each session.",
    workouts: [
      { title: "Monday — Push A", focus: "Chest-led pressing, shoulders and triceps", exercises: [["barbell-bench-press",4,6,8,180,2,"Tempo 2-0-1. Rest 2–3 minutes."], ["incline-dumbbell-press",3,8,10,120,2,"Tempo 2-0-1. Rest 90–120 seconds."], ["seated-dumbbell-overhead-press",3,8,10,120,2,"Tempo 2-0-1. Rest 90–120 seconds."], ["cable-chest-fly",2,12,15,90,2,"Tempo 2-1-2. Rest 60–90 seconds."], ["dumbbell-lateral-raise",3,12,15,75,2,"Tempo 2-1-2. Rest 60–75 seconds."], ["cable-triceps-pressdown",3,10,15,75,2,"Use a rope attachment. Tempo 2-1-1. Rest 60–75 seconds."]] },
      { title: "Tuesday — Pull A", focus: "Hamstrings, vertical pulling, upper back and biceps", exercises: [["dumbbell-romanian-deadlift",3,6,8,180,2,"A barbell Romanian deadlift is an equivalent option. Tempo 2-0-1. Rest 2–3 minutes."], ["lat-pulldown",4,6,10,120,2,"Pull-ups are an equivalent option. Tempo 2-0-1. Rest 90–120 seconds."], ["chest-supported-dumbbell-row",3,8,10,120,2,"Tempo 2-1-1. Rest 90–120 seconds."], ["seated-cable-row",2,10,12,90,2,"Perform one arm at a time. Tempo 2-1-1. Rest 60–90 seconds."], ["face-pull",3,12,15,75,2,"Use a reverse pec deck or rear-delt fly if preferred. Tempo 2-1-2. Rest 60–75 seconds."], ["incline-dumbbell-curl",3,8,12,75,2,"An EZ-bar curl is the intended equivalent. Tempo 2-0-1. Rest 60–75 seconds."], ["incline-dumbbell-curl",2,10,12,75,2,"Use a neutral grip to perform these as hammer curls. Tempo 2-0-1. Rest 60–75 seconds."]] },
      { title: "Wednesday — Legs A", focus: "Squat-led quads, hamstrings, calves and abs", exercises: [["barbell-back-squat",4,6,8,180,2,"Tempo 2-0-1. Rest 2–3 minutes."], ["leg-press",3,10,12,120,2,"Tempo 2-0-1. Rest 90–120 seconds."], ["seated-leg-curl",3,10,12,90,2,"Tempo 2-1-1. Rest 60–90 seconds."], ["walking-lunge",2,10,12,90,2,"Prescription is per leg. Tempo 2-0-1. Rest 60–90 seconds."], ["standing-calf-raise",4,10,15,75,2,"Tempo 2-1-1. Rest 60–75 seconds."], ["cable-crunch",3,10,15,60,2,"A hanging knee raise is the intended equivalent. Use a controlled tempo and rest 45–60 seconds."]] },
      { title: "Thursday — Push B", focus: "Upper chest, machine pressing, delts and triceps", exercises: [["incline-dumbbell-press",4,6,8,180,2,"Use an incline barbell bench press if available. Tempo 2-0-1. Rest 2–3 minutes."], ["dumbbell-bench-press",3,8,12,120,2,"A machine chest press is the intended equivalent. Tempo 2-0-1. Rest 90–120 seconds."], ["seated-dumbbell-overhead-press",3,8,10,120,2,"Use a shoulder-press machine or Arnold press if preferred. Tempo 2-0-1. Rest 90–120 seconds."], ["dumbbell-lateral-raise",3,12,15,75,2,"A cable lateral raise is the intended equivalent. Tempo 2-1-2. Rest 60–75 seconds."], ["cable-triceps-pressdown",3,10,15,75,2,"Perform as an overhead cable triceps extension when the station allows it. Tempo 2-1-1. Rest 60–75 seconds."], ["cable-chest-fly",2,12,15,75,2,"Use a pec deck or deficit push-up if preferred. Controlled tempo. Rest 60–75 seconds."]] },
      { title: "Friday — Pull B", focus: "Heavy hinge, lats, rows, rear delts and biceps", exercises: [["barbell-deadlift",3,5,5,180,2,"Use a trap-bar deadlift or rack pull. Tempo 2-0-1. Rest 2–3 minutes."], ["lat-pulldown",3,8,10,120,2,"Use a neutral-grip handle. Tempo 2-0-1. Rest 90–120 seconds."], ["seated-cable-row",3,8,12,120,2,"Tempo 2-1-1. Rest 90–120 seconds."], ["chest-supported-dumbbell-row",2,10,12,90,2,"Perform one arm at a time as a one-arm dumbbell row. Tempo 2-1-1. Rest 60–90 seconds."], ["face-pull",3,12,15,75,2,"Tempo 2-1-2. Rest 60–75 seconds."], ["incline-dumbbell-curl",3,10,12,75,2,"Tempo 2-0-1. Rest 60–75 seconds."], ["incline-dumbbell-curl",2,12,15,75,2,"A standard cable curl is the intended equivalent. Tempo 2-0-1. Rest 60–75 seconds."]] },
      { title: "Saturday — Legs B", focus: "Quad variation, glutes, unilateral legs, hamstrings, calves and abs", exercises: [["barbell-back-squat",4,6,8,180,2,"Perform as a front squat, or use a hack-squat machine. Tempo 2-0-1. Rest 2–3 minutes."], ["hip-thrust",3,8,10,120,2,"Tempo 2-1-1. Rest 90–120 seconds."], ["rear-foot-elevated-split-squat",3,8,10,90,2,"Bulgarian split squat; prescription is per leg. Tempo 2-0-1. Rest 60–90 seconds."], ["leg-extension",2,12,15,75,2,"Tempo 2-1-1. Rest 60–75 seconds."], ["seated-leg-curl",3,10,12,90,2,"Use a lying leg curl if available. Tempo 2-1-1. Rest 60–90 seconds."], ["standing-calf-raise",3,12,15,75,2,"A seated calf raise is the intended equivalent. Tempo 2-1-1. Rest 60–75 seconds."], ["front-plank",3,30,60,60,2,"Use an ab wheel if proficient, otherwise hold a front plank for 30–60 seconds. Controlled reps; rest 45–60 seconds."]] },
    ],
  },
  {
